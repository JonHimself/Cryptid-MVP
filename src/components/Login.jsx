...
const Login = ({signIn, signOut, handleOk, handleCancel, showModal, isModalVisible }) => {
  ...
  const openNotificationOut = (user) => {
    ...
    return (
        ...
        {!loggedIn && !loggedOut ?
        <Modal title="Log In" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} cancelButtonProps={{style: {display: 'none'}}} okButtonProps={{style: {display: 'none'}}}>
